...
import os
os.environ['HF_HOME'] = '/opt/data/private/lk/Huggingface'#更改默认下载位置
# # os.environ['HF_ENDPOINT'] = 'https://hf-mirror.com'
os.environ['HF_ENDPOINT'] = 'https://alpha.hf-mirror.com'#更加稳定
...
def main():
    ...
    trainer.model.config.use_cache = False#修复
